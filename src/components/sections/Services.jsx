    ...
    <div>
      <div className="section-header">
        ...
        <p>
          ...
          sapiente mollitia error illo totam magnam fugit? Veniam id dolores
          accusamus. Praesentium, voluptate excepturi dolorum perspiciatis
          cupiditate recusandae molestiae tempore? Asperiores.
        </p>
      </div>
              ...
              <div className="mil-card-1 mil-complex-hover mil-icon-2-trigger mil-accent-trigger mil-pseudo-hover">
                ...
                >
                  <div className="mil-top-hidden mil-flex justify-content-between">
                    ...
                    {/* number */}
                    <div className="mil-text-lg mil-softened-40">
                      {item.num}
                    </div>
                  </div>
                  <div className="mil-bottom-part-hidden">
                    ...
                    <p className="mil-hidden-part mil-softened-40">
                      {item.text}
                    </p>
                  </div>
                </Link>
